...
def main():
	...
	if(returnedValue != ""):
		print("failed isTriangle: " + returnedValue)
        else: 
                print("Passed Is Triangle Test")

        returnedValue = testIsRight()
        if(returnedValue != ""):
                print("failed IsRight: " + returnedValue)
        else: 
                print("Passed isRight Test")

        returnedValue = testIsAcuteObtuse()
        if(returnedValue != ""):
                print("failed isAcuteObtuse: " + returnedValue)
        else: 
                print("Passed isAcuteObtuse Test")

        returnedValue = testIsIsoScalene()
        if(returnedValue != ""):
                print("failed isIso: " + returnedValue)
        else: 
                print("Passed isIso Test")
